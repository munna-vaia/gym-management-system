 ...
 * @author Asus
 */
public class newmenber extends javax.swing.JFrame {
    ...
    public newmenber() {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select max(id) from menber");
            while (rs.next()) {
                id = rs.getInt(1);
                id = id + 1;
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Algerian", 1, 43)); // NOI18N
        ...
        jLabel11.setText("amount to payment/month");
...
// TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String amountpayment = jTextField6.getText();
        try {
            Connection con = ConnectorProvider.getCon();
            PreparedStatement ps = con.prepareStatement("insert into menber values (?,?,?,?,?,?,?,?,?)");
            ps.setString(1, id);
            ps.setString(2, name);
            ...
            ps.setString(8, age);
            ps.setString(9, amountpayment);
            ps.executeUpdate();
            JOptionPane.showConfirmDialog(null, "successfully save");
            setVisible(false);
            new newmenber().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(newmenber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
